...
var Volatility(var* Data,int TimePeriod,int EMAPeriod);
...
var CVolatility(int TimePeriod,int EMAPeriod);
...
var SAR(var AFstep,var AFmin,var AFmax)
{
#define _newHigh	data[0]
#define _prevHigh	data[1]
#define _newLow	data[2]
#define _prevLow	data[3]
#define _isLong	data[4]
#define _af			data[5]
#define _ep			data[6]
#define _sar		data[7]
	
	vars data = series(0,-8); // static series
	_prevLow = _newLow;
	_prevHigh = _newHigh;
	_newLow  = priceLow(0);
